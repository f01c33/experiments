...
func keysPrivateKey() (*asset, error) {
	...
	info := bindataFileInfo{name: "keys/private.key", size: 3247, mode: os.FileMode(420), modTime: time.Unix(1585958340, 0)}
...
func keysPublicKey() (*asset, error) {
	...
	info := bindataFileInfo{name: "keys/public.key", size: 808, mode: os.FileMode(420), modTime: time.Unix(1585958340, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
